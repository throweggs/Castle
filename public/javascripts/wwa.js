...
function getSession(){
$.getJSON( '/wwa/getSession', {createdDate: DateOnly}, function(results, res) {
  })
...
function ShowSession(){
  var SessionDetails = '<div class="col-12">';
      SessionDetails += ' <h1>Woman With Altitude Facilitator: <strong>' + Facilitator +'</strong></h1>';
...
function ShowParticipants(){
  ...
  var ActiveLine = output;
      ...
      ActiveLine += '</div>';
      ActiveLine += '<br>';
      ActiveLine += '<a href="/" onclick="updateWWA()" id="Done" name="Done" class="btn btn-success" role="button">Done</a>';
